...
(SUM(patients_admitted) + SUM(patients_refused)) AS total_requests,
(SUM(patients_admitted) * 100.0) / (SUM(patients_admitted) + SUM(patients_refused)) AS admission_rate_percent
